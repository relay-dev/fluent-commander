...
{
    public class ConnectionStringFromConfigurationProvider : IConnectionStringProvider
    {
        private readonly IConfiguration _configuration;

        public ConnectionStringFromConfigurationProvider(IConfiguration configuration)
        {
