...
{
    public class OracleDatabaseRequestHandler : DatabaseRequestHandlerBase
    {
        private readonly OracleConnectionStringBuilder _builder;

        public OracleDatabaseRequestHandler(OracleConnectionStringBuilder builder, DatabaseCommandBuilder databaseCommandBuilder)
