...
namespace IntegrationTests.SqlServer.CommandsAsync
{
    ...
    public class SqlNonQueryCommandAsyncIntegrationTests : IntegrationTest<IDatabaseCommander>
    {
        ...
        public async Task ExecuteSqlNonQueryCommandAsync_UpdateWithInputParameters_ShouldUpdateTheDatabase()
        {
            ...
            // Act
            SqlNonQueryCommandResult result = await SUT.BuildCommand()
...
@"INSERT INTO [dbo].[SampleTable]
     ...
     VALUES
           ...
           ,@CreatedDate)";
            ...
            SqlNonQueryCommandResult insertResult = await SUT.BuildCommand()
            ...
            SqlNonQueryCommandResult deleteResult = await SUT.BuildCommand()
